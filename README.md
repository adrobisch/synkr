...
synkr uses `sbt` and `sbt-native-packager` which can produce various package types, see the documentation for details: https://github.com/sbt/sbt-native-packager
